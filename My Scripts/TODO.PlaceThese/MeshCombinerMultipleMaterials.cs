...
public class MeshCombinerMultipleMaterials : MonoBehaviour
{
    ...
    public void CombineMeshes()
    {
        ...
        //get first child's materials.
        sharedMaterials = GetComponentsInChildren<Renderer>()[1].materials;
        ...
        //Assign myRenderer all the materials (This might be done out of order)
        myRenderer.sharedMaterials = sharedMaterials;

        int numMats = sharedMaterials.Length;
        //Reassign materials in the correct order.
        for (int i = 0; i < numMats; i++)
        {
            myRenderer.sharedMaterials[i] = sharedMaterials[i];
        }
